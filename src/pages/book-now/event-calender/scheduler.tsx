              ...
              >
                <div className="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  <div className="relative pl-6 pr-6 flex-auto">
                    <p className="my-4 text-black-500 text-2xl leading-relaxed p-2">
                    ...
                    <p className="my-4 text-red-500 text-lg leading-relaxed p-2">
                      Please note that a slot is limited to 30 mins*
                    </p>
                  </div>
                  <div className="justify-start p-4 w-auto">
                    <button
